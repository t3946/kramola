...
app.config['PREDEFINED_LISTS'] = {
    ...
    PredefinedListKey.DANGEROUS.value: "Опасные слова",
    PredefinedListKey.FOREIGN_AGENTS_PERSONS.value: "Иноагенты (ФИО)",
    PredefinedListKey.FOREIGN_AGENTS_COMPANIES.value: "Иноагенты (Организации)",
...
app.config['PREDEFINED_LISTS_DESCRIPTIONS'] = {
    PredefinedListKey.PROFANITY.value: (
        "Перечень нецензурной, обсценной и грубо-бранной лексики, "
        "включая распространённые ругательные формы и их варианты"
    ),
    PredefinedListKey.PROHIBITED_SUBSTANCES.value: (
    ...
    PredefinedListKey.DANGEROUS.value: (
    ...
    PredefinedListKey.FOREIGN_AGENTS_PERSONS.value: (
        "Список физических лиц, включённых в реестр иностранных агентов Минюста России"
    ),
    PredefinedListKey.FOREIGN_AGENTS_COMPANIES.value: (
        "Список организаций, включённых в реестр иностранных агентов Минюста России"
    ),
    PredefinedListKey.EXTREMISTS_INTERNATIONAL_FIZ.value: (
    ...
    PredefinedListKey.EXTREMISTS_INTERNATIONAL_UR.value: (
        "Список организаций из перечня Росфинмониторинга, в отношении которых "
        "имеются сведения о причастности к экстремистской деятельности или терроризму"
    ),
    PredefinedListKey.EXTREMISTS_RUSSIAN_FIZ.value: (
        "Список физических лиц из перечня Росфинмониторинга, в отношении которых "
        "имеются сведения о причастности к экстремистской деятельности или терроризму"
    ),
    PredefinedListKey.EXTREMISTS_RUSSIAN_UR.value: (
        "Список организаций из перечня Росфинмониторинга, в отношении которых "
        "имеются сведения о причастности к экстремистской деятельности или терроризму"
    ),
}
