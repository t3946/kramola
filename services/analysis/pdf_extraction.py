...
class PDFExtractor:
    ...
    def _extract_logical_words_from_block(self, block_words: List, block_rect: pymupdf.Rect) -> List[Dict[str, any]]:
        """
    ...
    def extract_all_logical_words_from_pdf(self, pdf_path: str) -> Optional[List[List[Dict[str, any]]]]:
        """
