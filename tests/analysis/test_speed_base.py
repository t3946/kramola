...
class BaseSpeedTest(BaseTest):
    """
    Base class for speed tests with common logic.
    Subclasses should set test_data_subdir, results_subdir, and test_dir_name.
    """
    ...
    def test_dir(self) -> Path:
        """Get specific test directory."""
        if not self.test_dir_name:
            raise ValueError("test_dir_name must be set as class attribute")
        return self.test_data_dir / self.test_dir_name
