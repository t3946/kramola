...
class TestSpeedUlList(BaseSpeedTest):
    """Speed test for ul-list dataset using Redis lists."""
    
    test_dir_name = 'ul-list'
    ...
    def run_single_test(self, test_dir: Path) -> Dict:
        ...
        analyse_data.load_predefined_lists([PredefinedListKey.FOREIGN_AGENTS_COMPANIES])
