...
VALID_EXTREMIST_AREAS: tuple[str, ...] = (ExtremistArea.INTERNATIONAL.value, ExtremistArea.RUSSIAN.value)
...
class WordsListView(BaseView):
    ...
    def data_route(self):
        ...
        if self.list_slug == SLUG_EXTREMISTS_TERRORISTS:
            ...
            if area_filter and area_filter not in VALID_EXTREMIST_AREAS:
                area_filter = None
